...
<div style="width:100%; background-color:yellow;color:black">
    ...
    <div style=" margin: auto; width: 50%;">
         ...
         <a href="https://fruutty.com/jwt-confirm/{token}  "> <button style=" width: 50%; color:deeppink; "> confirm </button>  </a> </br>
...
<div style=" width: 100%; background-color: deeppink; color: white" >
  ...
  <h1>  This is a no reply message  </h1>
...
"""
    ...
    <p> Click the link to create your employment password --> : https://fruutty.com/employment-id/{token}  </p> </br>
